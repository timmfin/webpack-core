...
function NormalModuleMixin(loaders, resource) {
	...
	var resourcePath = this._resourcePath();
...
NormalModuleMixin.prototype._resourcePath = function resourcePath() {
	return this.splitQuery(this.resource)[0];
};

NormalModuleMixin.prototype._resourceQuery = function resourceQuery() {
	return this.splitQuery(this.resource)[1];
};
...
NormalModuleMixin.prototype.doBuild = function doBuild(options, moduleContext, resolver, fs, callback) {
	...
	var loaderContext = {
		...
		resourceQuery: this.resource ? this._resourceQuery() || null : undefined,
	...
	function onLoadPitchDone() {
		...
		if(resourcePath) {
			...
			fs.stat(resourcePath, function(err, stat) {
				...
				this._mtime = stat.mtime.getTime();
